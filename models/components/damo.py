...
class Discriminator(nn.Module):
    def __init__(self, debug=False):
        ...
        self.conv1_0 = conv_block(
            64, 128, kernel_size=4, stride=1, padding="same", leaky=True
        )
        self.conv2_0 = conv_block(
            128, 1, kernel_size=4, stride=1, padding="same", leaky=True
        )
        ...
        self.conv1_1 = conv_block(
            64, 128, kernel_size=4, stride=1, padding="same", leaky=True
        )
        self.conv2_1 = conv_block(
            128, 1, kernel_size=4, stride=1, padding="same", leaky=True
        )
