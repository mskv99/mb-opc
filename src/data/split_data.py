...
def move_matching_files(origin_dir, correction_dir, dest_origin_dir, dest_correction_dir, percentage=0.1):
...
move_matching_files(train_origin_dir, train_correction_dir, valid_origin_dir, valid_correction_dir, percentage=0.01)
