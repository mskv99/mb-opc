...
from src.utils import IouLoss, next_exp_folder, IoU, PixelAccuracy, draw_plot, BoundaryLoss
...
def train_model(model,
  ...
  if resume:
    checkpoint = torch.load(
      '/mnt/data/amoskovtsev/mb_opc/checkpoints/exp_10/last_checkpoint.pth')  # torch.load(os.path.join(checkpoint_dir, "checkpoint_14.10.24.pth"))
