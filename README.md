...
```
git clone https://gitflic.ru/project/moskovtsev-af-phystech-edu/mb_opc.git
cd mb_opc
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/moskovtsev-af-phystech-edu/mb_opc.git
git clone
